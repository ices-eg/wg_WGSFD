...
dat2plot$ratio <- with(dat2plot, pmax(fishing_hours, 1e-9)/ pmax(fishing_hours_median, 1e-9))
...
# calculate ratio (with exceptions for zeros)
dat2plot$ratio <- with(dat2plot, pmax(fishing_days, 1e-9)/ pmax(fishing_days_median, 1e-9))
