...
ICES_LE <- read.table("data/QC_2020/ICES_LE_BEL.csv",
  sep = ",", header = TRUE,
...
ICES_VE <- read.table("data/QC_2020/ICES_VE_BEL.csv",
  sep = ",", header = TRUE,
  stringsAsFactors = FALSE, na.strings = "NULL",
  colClasses = c(
    "character", "character",
