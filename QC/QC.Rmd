...
ICES_LE <- read.table('data/ICES_LE_DNK.csv', sep = ',', header = TRUE,
          stringsAsFactors = FALSE, na.strings = 'NULL',
          colClasses = c('character', 'character', 'numeric', 'numeric',
                         'character', 'character', 'character', 'numeric',
                         'character', 'character',
                         'numeric', 'numeric', 'numeric'))
ICES_VE <- read.table('data/ICES_VE_DNK.csv', sep = ',', header = TRUE,
          stringsAsFactors = FALSE, na.strings = 'NULL',
          colClasses = c('character', 'character', 'numeric', 'numeric',
...
dat2tab <- as.matrix(aggregate(ICES_LE$SI_LONG, by = list(year = ICES_LE$year), FUN=range))
