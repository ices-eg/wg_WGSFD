---
title: "Tables of DCF indicators"
author: "mathieu woillez"
...
wd <- "C:/Users/mwoillez/Documents/Mon travail/ICES/WGSFD/2017/R scripts/DCF indicators"
setwd(wd)
...
kable(DCF5o1, digits=2)

kable(DCF5o1r,digits=2)
  
kable(DCF5o2, digits=2)

kable(DCF5o2r,digits=2)

kable(DCF5o3, digits=2)

kable(DCF5o3r,digits=2)

kable(DCF5subo1, digits=2)

kable(DCF5subo1r,digits=2)
  
kable(DCF5subo2, digits=2)

kable(DCF5subo2r,digits=2)

kable(DCF5subo3, digits=2)

kable(DCF5subo3r,digits=2)
  
kable(DCF6,digits=2)
  
kable(DCF6r,digits=2)
  
kable(DCF6sub,digits=2)

kable(DCF6subr,digits=2)
  
kable(DCF7o1,digits=2)  
  
kable(DCF7o1r,digits=2)  

kable(DCF7o2,digits=2)  
  
kable(DCF7o2r,digits=2)  

kable(DCF7o3,digits=2)  
  
kable(DCF7o3r,digits=2)  

kable(A_FI0.7,digits=2)
  
kable(A_FI0.8,digits=2)
  
kable(A_FI0.9,digits=2)

kable(avg_intensity,digit=2)
